export default function HSAPayment() {
  return (
    <div className="flex flex-wrap items-center justify-center gap-2 text-sm text-[#50000b]">
      <span className="font-semibold">Pay with HSA/FSA</span>
      ...
      <span className="text-[#50000b]/70">Save an average of 30%</span>
